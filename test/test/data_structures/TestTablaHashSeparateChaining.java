...
public class TestTablaHashSeparateChaining {
	private TablaHashSeparateChaining <Integer,Integer>HT;
	
	@Before
	public void setUp1() {
		HT = new TablaHashSeparateChaining <Integer,Integer>(1);
	}
	
	
	@Before
	public void setUp2() {
		HT = new TablaHashSeparateChaining <Integer,Integer>(10);
		for (int i = 0; i<10;i++)
		{
			HT.put(i, i+1);
		}
	...
	@Test
	public void tablaHashSeparateChainingtest() {
		setUp1();
	...
	public void testGet() {
		setUp1();		
		assertTrue("La lista retornada debio ser nula", HT.get(1) == null);
	...
	public void testRehash() {
		...
		assertTrue("Se debio efectuar un rehash: " + HT.M,HT.M == 2);
