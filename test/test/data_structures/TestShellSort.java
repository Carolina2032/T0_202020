...
public class TestShellSort {
	...
	public void testoOrdenarAleatorios() {
		...
		System.out.println("El Tiempo de ordenamiento Shell Sort para "+N+" datos Aleatorio (seg): " + (end-start)/1000.0);
	...
	public void testoOrdenarAscendentes() {
		...
		System.out.println("El Tiempo de ordenamiento Short Sort para "+N+"  datos Ascendentes (seg): " + (end-start)/1000.0);
	...
	public void testoOrdenarDescendentes() {
		...
		System.out.println("El Tiempo de ordenamiento Short Sort para "+N+" datos Descendentes (seg): " + (end-start)/1000.0);
